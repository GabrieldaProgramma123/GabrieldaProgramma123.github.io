...
function animate() {
  ...
  if (gameLoop) {
    ...
    // didyoutouchacoin tester   for (let x of buttonPoses) {
...
function vacation() {
  var askfly = confirm("Ready to fly? 25 coins per trip!");
  if (askfly) {
    if (money >= 25) {
